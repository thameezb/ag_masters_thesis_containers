...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \bullettext{This project compares the various options differing in:}
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{0.6\textwidth}
      \bullettext{This project aimed to compare each \emph{Cloud Container Orchestration} platform in respect to}:
      \begin{itemize}
