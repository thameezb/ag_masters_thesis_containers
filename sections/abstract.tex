\begin{abstract}
  ...
  In parallel, a mass adoption of the Cloud Computing paradigm has occurred during the same time period. 
  Reacting to this mass adoption, cloud-providers have rolled out various container-orchestration platforms, 
  each offering: a set of unique features, limitations, and challenges; with the divisions between each offering being fuzzy.
  This thesis compares a set of the most popular cloud container-orchestration platforms in terms of backend type (that being Virtual Machines or Serverless);
